...
<title>TALENTO TV</title>
<link rel="shortcut icon" type="image/-icon" href="images/talento.ico">
        ...
        <div class="app-block">
          <div class="app-form login-form">
            <div class="form-header">
              <div class="app-brand"><img class="img" width="140" src="images/talento-tv.png"></div>
            </div>
            ...
            <form action="login_db_cli.php" method="post">
